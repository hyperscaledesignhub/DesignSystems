"""
Simple Consumer Service for Demo
"""
...
BROKER_URLS = ["http://msgqueue-broker-1:19001", "http://msgqueue-broker-2:19001", "http://msgqueue-broker-3:19001"]
COORDINATOR_URL = "http://msgqueue-coordinator:19004"

@app.on_event("startup")
async def startup():
    print("Consumer service started on port 19003")
